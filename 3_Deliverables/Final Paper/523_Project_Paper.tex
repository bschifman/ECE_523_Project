...
The RFC was run with all of the original features and the percentage of feature importances were plotted in \Cref{fig:RFC}.
...
\subsection{Principal Component Analysis (PCA)}
\Cref{fig:PCA} depicts the PCA accuracy and time taken with its corresponding reduced feature set of principal components.
