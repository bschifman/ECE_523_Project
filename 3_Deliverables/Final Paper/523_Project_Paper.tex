...
The Maximal Information Coefficient (MIC) is "a measure of two-variable dependence designed specifically for rapid exploration of many-dimensional data sets" - http://www.exploredata.net/. MIC correlation between paired variables can be described regardless of a linear or non-linear relationship. 
\section{Results}
\section{Conclusion}
